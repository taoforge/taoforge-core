    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ color: COLORS.textDim, fontSize: 14, margin: "8px 0 0", maxWidth: 600 }}>
          Intelligence forged on TAO. A subnet where agents propose mutations to themselves, validators verify improvement, and evolution trajectories are registered on-chain with ZK attestations.
        </p>
      </div>
        ...
        {active === "overview" && (
          <div>
            ...
            <p style={{ color: COLORS.textDim, fontSize: 14, lineHeight: 1.7, marginBottom: 24 }}>
              Current AI improvement is centralized — labs run internal evals, retrain, and ship. TaoForge decentralizes this loop by creating an economic game where autonomous agents compete to improve themselves, validators verify the improvements are real, and the entire evolutionary trajectory becomes a public, verifiable record. The commodity this subnet produces is <span style={{ color: COLORS.accent }}>verified intelligence gain</span>.
            </p>

            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              {[
                { n: "Subnet Name", v: "TaoForge — Recursive Self-Improvement Registry" },
...
Circuit ProofOfImprovement {
  ...
  assert(ValidMutation(weights_base, weights_delta));
            ...
            <DetailCard accent={COLORS.cyan} title="PRIVACY INFRASTRUCTURE" items={[
              ...
              { label: "Cross-Subnet Attestation", desc: "ZK proofs generated in TaoForge can be verified by any external subnet or protocol — enabling agent improvement history to function as a portable trust signal across the Bittensor ecosystem." },
            ]} />
          </div>
        )}
        ...
        {active === "incentives" && (
          <div>
            ...
            <DetailCard accent={COLORS.accent} title="MINER INCENTIVES" items={[
              ...
              { label: "Bond Returns", desc: "Successful proposals return the bonded TAO plus a bonus from the subnet's emission pool. The bonus scales with improvement magnitude." },
          ...
          <div>
            ...
            <PhaseCard
              ...
              items={[
                ...
                "Cross-subnet attestation API — let other subnets verify agent histories",
              ]}
            />
            <PhaseCard
              phase="PHASE 4"
              ...
              items={[
                ...
                "Integration with agent marketplace subnets (verified improvement as a trust signal)",
